...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (prefs.getString(MapFragment.PREF_TRACCAR_DEVICE_ID, "").isNullOrBlank()) {
            prefs.edit().putString(MapFragment.PREF_TRACCAR_DEVICE_ID, "${(10000000..99999999).random()}").apply()
        }
